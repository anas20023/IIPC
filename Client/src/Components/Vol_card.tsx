const Vol_card = ({ name, section, workSection, imgSrc }) => {
    return (
        <div className="w-full bg-white border border-gray-200 rounded-lg shadow-lg hover:bg-gray-50 transition-all duration-300 ease-in-out flex flex-col md:flex-row md:items-center my-4">
            <img
                className="object-cover w-full rounded-t-lg h-full min-h-[96] md:w-48 md:rounded-none md:rounded-s-lg"
                src={imgSrc}
                alt={`${name}'s work`}
            />
